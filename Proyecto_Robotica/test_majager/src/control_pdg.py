...
if __name__ == '__main__':
  ...
  Kp = 0.3*np.diag(np.array([6,6,11,2,2,5,1]))
  Kd = 0.3*np.diag(np.array([26,25,37,6,10,40,2.5]))
  """
  Kp = 0.6 * np.diag(np.array([6, 6, 11, 2, 2, 5, 1]))
  Kd = 0.6 * np.diag(np.array([26, 25, 37, 6, 10, 40, 2.5]))
  """
  ...
  print('ending motion ...')
  print("\n")
  print("Articulación: " + "q1: " + str(round(q[0], 4)) + " rad, q2: " + str(round(q[1], 4)) + " rad, q3: " + str(
    round(q[2], 4)) + " rad")
  print("              q4: " + str(round(q[3], 4)) + " rad, q5: " + str(round(q[4], 4)) + " rad, q6: " + str(
    round(q[5], 4)) + " m, q7: " + str(
    round(q[6], 4)) + " rad")
  ...
  print("              q4: " + str(qd[3]) + " rad, q5: " + str(qd[4]) + " rad, q6: " + str(qd[5]) + " m, q7: " + str(
    qd[6]) + " rad")
  print("Posición deseada: " + "X: " + str(round(xd[0], 4)) + ", Y: " + str(round(xd[1], 4)) + ", Z: " + str(
    round(xd[2], 4)))
  print(
